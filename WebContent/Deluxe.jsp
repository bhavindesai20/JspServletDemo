    ...
    <div id="container">
		...
		<%	
			...
			<div id="mainContent" style="background-color:#F4EEE2;padding-bottom:20px">
				<p class="titleWord">Deluxe Room
				<%   
			if(session.getAttribute("f_name") != null){
	  	%>  
                 <span class="bookLink"><a href="MyDelux.jsp">Book This Room</a><span>
		<%}else{%>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p class="commonDescription">
          Unwind in one of our oversized, smoke-free Deluxe Rooms, featuring two plush queen-sized beds, a small sofa, 2 chairs, a coffee table, crisp linens, 37-inch LCD flat-screen televisions with premium cable, seating areas with club chairs, ergonomic workstations, complimentary Wi-Fi, deep soaker tubs, fluffy towels, coffee makers, and mini-fridge and microwave oven. These rooms feature two double beds and are the perfect choice for families or groups with multiple occupants. Stay in downtown Chicago near Grant Park, Museum campus, Soldier Field, McCormick Place and more
