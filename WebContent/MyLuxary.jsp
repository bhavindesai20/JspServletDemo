...
<body>
    <div id="container">
		...
		<%	
			...
			<div id="mainContent">
		<div style="padding-left:200px;padding-top:20px;padding-bottom:40px;background-image:url(images/stand1.jpg);background-repeat:no-repeat;">
		<h2 style="color:#09144A">Book Luxary Room</h2>
          ...
          <tr>
            <td style="color:white" class="left"><label for="itemID"><strong>Type of room: </label></td>
			            <td class="right">
                           ...
                           <select name="itemID">
                                    <option value="Luxary_Hollywood" selected>Luxary_Hollywood</option>
                                    <option value="Luxary_Cabana">Luxary_Cabana</option>
                                    <option value="Luxary_Lanai">Luxary_Lanai</option>
                           </select>
			</td>
