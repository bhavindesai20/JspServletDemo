        ...
        <section id="header">
          <div style="float:left;padding-top:10px;"><h1>&nbsp;&nbsp;&nbsp;The Grand Bhagwati</h1></div>
			...
			<div style="background-color:#BBC4E1;height:300px;padding-top:10px;padding-left:20px;padding-right:20px;">
				<h1 style="color:white;  text-align: center;"> Thank you so much for Sign Up!</h1>
				<img src="images/thanks.png" style="padding-left:350px" width="300px" height="150px"/>
				<br>
			 <%   
	  	...
	  	%> 
			...
			<%}else{%>
				...
				<span style="padding-left:150px" class="bookLink"><a href="index.jsp">Home</a><span>
